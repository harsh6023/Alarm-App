...
public class AlarmAdapter extends RecyclerView.Adapter<AlarmAdapter.ViewHolder> {
	 ...
	 * @param listener An instance of  {@link AdapterInterface} that will listen to click events.
	 * @param context The context.
	 */
	public AlarmAdapter(@NonNull ArrayList<AlarmData> alarmDataArrayList, @NonNull AdapterInterface listener,
